...
ENT.PrintName = "HL2 Trabant 2"

ENT.GlideCategory = "HL2Prewar"
ENT.ChassisModel = "models/blu/trabant/trabant02_r.mdl"
...
if SERVER then
    ...
    function ENT:CreateFeatures()
        self:CreateSeat( Vector( -2, 14, 12 ), Angle( 0, -90, 5 ), Vector( 6, 76, 4 ), true )
        self:CreateSeat( Vector( -2, -14, 12.5 ), Angle( -0.000000, -90, 8 ), Vector( 6, -76, 4 ), true )
        self:CreateSeat( Vector( -2, -0, 12.5 ), Angle( -0.000000, -90, 8 ), Vector( 6, -76, 4 ), true )
